...
foreach ($kq as $key => $row) {
    ?>
              ...
              <th><a href="xoa_contact.php?maxoa=<?php echo $row['id'] ?>"><input type="submit" name="" value="Delete" onclick="return confirm('ban co muon xoa k ?')" ></a></th>
            </tr>
          <?php }
?>
        </tbody>
