...
?>
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                <img src="./admin/images/img_sli/<?php echo $sli['images'] ?>"
                    style="width:710px;height: 400px;margin-left: 500px">
                <div class="text"></div>
            </div>
            <?php endforeach?>
            <div>
...
$products = executeQuery($sqlQuery, true);?>
                            ...
                            <div class="owl-item deals_item">
                                <div class="deals_image"><a
                                        href="<?php echo BASE_URL . "detail.php?id=" . $pro['id'] ?>"><img
                                            src="./admin/images/img_pro/<?php echo $pro['feature_image'] ?>"
                                            alt="" /></a></div>
                                <div class="deals_content">
                                    ...
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_name"><a
                                                href="<?php echo BASE_URL . "detail.php?id=" . $pro['id'] ?>"><?php echo $pro['name'] ?></a>
                                        </div>
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <img src="./admin/images/img_pro/<?php echo $pro['feature_image'] ?>"
                                                alt="" /></div>
                                        <div class="product_content">
                                            <div class="product_price discount"><del
                                                    style="margin: 20px">$<?php echo number_format($pro['price'], 0, '', ','); ?></del><a
                                                    href=""
                                                    style="color: black;font-size:15px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></a>
                                            </div>
...
?>
                                            ...
                                            <div class="product_extras">
                                                ...
                                                <button class="product_cart_button"><a
                                                        href="<?php echo BASE_URL . 'add-cart.php?id=' . $pro['id'] ?>"
                                                        class="btn btn-extra-small btn-dark-border  "><i
                        ...
                        <div class="owl-item">
                            <div
                                ...
                                <div class="viewed_image"><img
                                        src="./admin/images/img_pro/<?php echo $pro['feature_image'] ?>" alt="" /></div>
                                <div class="viewed_content text-center">
                                    <div class="viewed_price"><del
                                            style="margin: 20px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></del><a
                                            href=""
                                            style="color: black;font-size:15px">$<?php echo number_format($pro['price'], 0, '', ','); ?></a>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="product_content">
                                                ...
                                                <div class="viewed_price"><del
                                                        style="margin: 20px">$<?php echo number_format($pro['price'], 0, '', ','); ?></del><a
                                                        href=""
                                                        style="color: red;font-size:15px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></a>
                                                </div>
                                                <div class="product_name">
                                                    <div><a
                                                            href="<?php echo BASE_URL . "detail.php?id=" . $pro['id'] ?>"><?php echo $pro['name'] ?></a>
...
$products = executeQuery($sqlQuery, true);?>
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <div class="arrivals_single_image"><img
                                            src="./admin/images/img_pro/<?php echo $pro['feature_image'] ?>" alt="" />
                                    </div>
                                    <div class="arrivals_single_content">
                                        <div class="arrivals_single_category"><del
                                                style="margin: 20px">$<?php echo number_format($pro['price'], 0, '', ','); ?></del><a
                                                href=""
                                                style="color: red;font-size:15px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></a>
                                        </div>
                                        <div class="arrivals_single_name_container clearfix">
                                            <div class="arrivals_single_name"><a href="#"><a
                                                        href="<?php echo BASE_URL . "detail.php?id=" . $pro['id'] ?>"><?php echo $pro['name'] ?></a></a>
                                            </div>
                                            <div class="arrivals_single_price text-right">$379</div>
                                        </div>

                                        <form action="#"><button class="arrivals_single_button"><a
                                                    href="<?php echo BASE_URL . 'add-cart.php?id=' . $pro['id'] ?>"
                                                    class="btn btn-extra-small btn-dark-border  "><i
                                                        class="fa fa-shopping-cart"></i> Add to cart</a></button></form>
                                    </div>
                                    <?php endforeach?>
                                </div>
                            </div>
...
?>
                                        ...
                                        <div class="bestsellers_price discount"><del
                                                style="margin: 20px">$<?php echo number_format($pro['price'], 0, '', ','); ?></del><a
                                                href=""
                                                style="color: black;font-size:15px">$<?php echo number_format($pro['sale_price'], 0, '', ','); ?></a>
                                        </div>
